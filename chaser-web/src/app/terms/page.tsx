...
const textClass = "text-sm leading-relaxed text-slate-700";
const listClass = "list-decimal space-y-2 pl-5 text-sm text-slate-700";
const nestedListClass =
  "mt-2 list-decimal space-y-1 pl-5 text-sm text-slate-700";
        ...
        <header className="room-hud room-fade">
          <div className="relative z-10 space-y-3">
            ...
            <p className="text-sm text-slate-300">
              CHaser Web のご利用条件をまとめています。
            </p>
          </div>
        </header>

        <article className="room-panel room-panel--strong space-y-8 p-6 sm:p-8 room-fade room-fade--delay-1">
          <section className="space-y-3">
            <p className={textClass}>
              この利用規約（以下，「本規約」といいます。）は，株式会社釧路オールアクション（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ol className={listClass}>
              ...
              <li>
                前項ただし書に定める場合であっても，当社は，当社の過失（重過失を除きます。）による債務不履行または不法行為によりユーザーに生じた損害のうち特別な事情から生じた損害（当社またはユーザーが損害発生につき予見し，または予見し得た場合を含みます。）について一切の責任を負わないものとします。また，当社の過失（重過失を除きます。）による債務不履行または不法行為によりユーザーに生じた損害の賠償は，ユーザーから当該損害が発生した月に受領した利用料の額を上限とします。
              </li>
              <li>
          ...
          <p className="text-right text-sm text-slate-500">以上</p>
        </article>
      </div>
    </main>
  );
